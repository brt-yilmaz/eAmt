      ...
      <div className="w-full sm:w-96 md:w-96 lg:w-96 xl:w-96 bg-gradient-to-b from-gray-800 via-gray-950 to-black rounded-lg py-5">
        <div className="p-5 rounded-lg border-t-4">
          ...
          <div className="flex justify-between mt-3">
            <Link href="/en/verify" className="text-blue-400 hover:underline block text-center">Verification</Link>
            <Link href="/en/login" className="text-blue-400 hover:underline block text-center">Login</Link>
          </div>
        </div>
      </div>
    </div>
